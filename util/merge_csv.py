...
def merge_csv(input_file):
    with open(input_file, encoding='utf-8') as f:
        ...
        user_name = os.path.basename(os.path.dirname(input_file))
        output_all = "./result/opensmile/result_all_add_sa.csv"
        output_all_user = './result/opensmile/{}/result_all_add_sa.csv'.format(user_name)
        ...
        with open(output_all, 'a', encoding='utf-8') as f:
            ...
            f.write('\n')
        with open(output_all_user, 'a', encoding='utf-8') as f:
            f.writelines(input_cont)
            f.write('\n')
